...
public class ConsulRegistryFactory implements RegistryFactory {
    ...
    public synchronized ServiceRegistry createServiceRegistry(RegistryConfig registryConfig) {
        return new ConsulServiceRegistry((ConsulRegistryConfig) registryConfig);
    }

    @Override
    public synchronized ServiceDiscovery createServiceDiscovery(RegistryConfig registryConfig) {
        return new ConsulServiceDiscovery((ConsulRegistryConfig) registryConfig);
    }

    @Override
    public boolean canApply(RegistryConfig registryConfig) {
        return registryConfig instanceof ConsulRegistryConfig;
    }
